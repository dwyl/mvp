# Credit: https://dev.to/onpointvn/build-your-own-date-time-parser-in-elixir-50be
# See: https://gist.github.com/bluzky/62a20cdb57b17f47c67261c10aa3da8b
defmodule App.DateTimeParser do
  ...
  **Example**:
  ...
  @doc """
  Parses the string according to the format.
  Pipes through regex compilation, casts each part of the string
  to a named regex capture and tries to convert to datetime.
  """
  def parse(dt_string, format \\ "%Y-%m-%dT%H:%M:%SZ") do
    format
    |> build_regex
