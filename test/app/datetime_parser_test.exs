defmodule App.DateTimeParserTest do
  ...
  test "valid parse of valid datetime" do
    parsed_time = DateTimeParser.parse!("2022-10-27 14:47:56", "%Y-%m-%d %H:%M:%S")
  ...
  test "valid timezone offset (with tz)" do
    ...
    parsed_date = DateTimeParser.parse!("2022-10-27T00:00:00Z+0230", "%Y-%m-%dT%H:%M:%SZ%z")
    {:ok, expected_datetime, 9000} = DateTime.from_iso8601("2022-10-27T00:00:00+02:30")
  ...
  test "valid timezone offset (with UTC)" do
    ...
    parsed_date = DateTimeParser.parse!("2022-10-27T00:00:00ZUTC+0230", "%Y-%m-%dT%H:%M:%SZ%Z")
  ...
  test "invalid timezone name" do
    ...
    assert_raise RuntimeError, fn ->
      DateTimeParser.parse!("2022-10-27T00:00:00ZEtc+0230", "%Y-%m-%dT%H:%M:%SZ%Z")
    end
  end
  ...
  test "valid datetime with PM/AM with two digits" do
    ...
    parsed_datetime = DateTimeParser.parse!("2022-10-27 06:02pm", "%Y-%m-%d %I:%M%P")
